...
public class GetUserResponse {
    ...
    public GetUserResponse(Long id, GetOrganizationResponse organization, StringAttributeResponse firstName, StringAttributeResponse lastName, String email, List<AddressResponse> address, StringAttributeResponse timezone, List<ApprovedAgreementResponse> approvedAgreement, ApprovedMarketInfoResponse approvedMarketInfo, List<LicensePlateResponse> licensePlates, SocialSecurityNumberResponse socialSecurityNumber, StringAttributeResponse customerNumber, BooleanAttributeResponse hasChargingAccess, StringAttributeResponse customerType, List<PhoneNumberResponse> phoneNumbers, StringAttributeResponse organizationNumber, List<StringAttributeResponse> roles, StringAttributeResponse language, InstantAttributeResponse activationDate, InstantAttributeResponse expirationDate) {
        this.id = id;
