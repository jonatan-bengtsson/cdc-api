...
class OrganizationMapper {
    ...
    static Organization toResponse(final OrganizationResponse organizationResponse) {
        ...
        return Organization.createBuilder()
                ...
                .phoneNumber(AttributeMapper.findPhoneNumberResponses(attributes, AttributeConstant.PHONE_NUMBER))
                .billingTelephone(AttributeMapper.findPhoneNumberResponses(attributes, AttributeConstant.BILLING_TELEPHONE))
                ...
                .contactPhoneNumber(AttributeMapper.findPhoneNumberResponses(attributes, AttributeConstant.CONTACT_PHONE_NUMBER))
