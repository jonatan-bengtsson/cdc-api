...
public class SessionHistoryRepositoryTest extends ElasticSearchTest {
    ...
    private final SessionHistoryRepository repository = new SessionHistoryRepository(OBJECT_MAPPER, client);

    @BeforeClass
    public static void setup() {
        ElasticSearchTest.setup("sessions", "_doc", testData());
    }
